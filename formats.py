class vote:
	text = '**Upvote** if this post has **good rhyme/meter ("True BootTooBig"). Downvote** if this post has **bad rhyme/meter ("Small Boots"). Report** this post if it requires further moderator action, such as being a repost or being offensive. \n\n'
...
footer = "---\n\nBoot_Size_Judge v0.3 (BETA) | [GitHub](https://github.com/aguamenti78/boot_size_judge/) | Contact: [Bot Maker](https://www.reddit.com/message/compose?to=le_haos&subject=[BSJ]) / [Mod Team](https://www.reddit.com/message/compose?to=%2Fr%2Fboottoobig)"

#for myLog.py
statusline = "Current time: {} | Error: {} | Uptime: {} | Task: {}"
summaryline = '[MAIN]New post processed: {}, watchlist post processed: {}, new error: {}, total error {}'
